...
@Autonomous(name="BlueClose_Charlotte", group="Charlotte Autonomae")
public class BlueClose_Charlotte extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        AutoTransitioner.transitionOnStop(this, "Close_AngelOp");
        ...
        switch(correctCryptoSlot){
            ...
            case "Center":
                ...
                break;
            case "Right":
                drive(-PI/2, 33+8, 1); //Be careful it's super close to hitting blue
                break;
        }
        drive(PI, 6, 1); //Adjusts to make room for rotate
